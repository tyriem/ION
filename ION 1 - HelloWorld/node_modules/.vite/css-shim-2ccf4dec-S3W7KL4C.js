...
// ../../../../../Documents/CODE/ION/ION 1 - HelloWorld/node_modules/@ionic/core/dist/esm-es5/css-shim-2ccf4dec.js
function parse(e) {
...
var __assign, StyleNode, types, OPEN_BRACE, CLOSE_BRACE, RX, VAR_START, MEDIA_START, AT_START, VAR_USAGE_START, VAR_ASSIGN_START, COMMENTS, TRAILING_LINES, IMPORTANT, FIND_DECLARATIONS, CSS_VARIABLE_REGEXP, CSS_URL_REGEXP, CustomStyle;
var init_css_shim_2ccf4dec = __esm({
  "../../../../../Documents/CODE/ION/ION 1 - HelloWorld/node_modules/@ionic/core/dist/esm-es5/css-shim-2ccf4dec.js"() {
    init_define_process_env();
    __assign = function() {
    ...
    types = { STYLE_RULE: 1, KEYFRAMES_RULE: 7, MEDIA_RULE: 4, MIXIN_RULE: 1e3 };
    OPEN_BRACE = "{";
    CLOSE_BRACE = "}";
    ...
    CSS_VARIABLE_REGEXP = /[\s;{]--[-a-zA-Z0-9]+\s*:/m;
    CSS_URL_REGEXP = /url[\s]*\([\s]*['"]?(?!(?:https?|data)\:|\/)([^\'\"\)]*)[\s]*['"]?\)[\s]*/gim;
    CustomStyle = function() {
      function e(e2, t) {
        this.win = e2, this.doc = t, this.count = 0, this.hostStyleMap = new WeakMap(), this.hostScopeMap = new WeakMap(), this.globalScopes = [], this.scopesMap = new Map(), this.didInit = false;
      }
...
init_css_shim_2ccf4dec();
//# sourceMappingURL=css-shim-2ccf4dec-S3W7KL4C.js.map
