...
// ../../../../../Documents/CODE/ION/ION 1 - HelloWorld/node_modules/@ionic/core/dist/esm/polyfills/dom.js
var init_dom = __esm({
  "../../../../../Documents/CODE/ION/ION 1 - HelloWorld/node_modules/@ionic/core/dist/esm/polyfills/dom.js"() {
    init_define_process_env();
    (function() {
      ...
      function x(a, b) {
        ...
        for (b = 0; b < d.length; b++) {
          var c = d[b];
          c.__CE_state === 1 ? a.connectedCallback(c) : y(a, c);
        }
      }
      function z(a, b) {
        var d = [];
        ...
        for (b = 0; b < d.length; b++) {
          var c = d[b];
          c.__CE_state === 1 && a.disconnectedCallback(c);
        }
      }
      function A(a, b, d) {
        d = d === void 0 ? {} : d;
        var c = d.u || new Set(), e = d.i || function(b2) {
          return y(a, b2);
        }, f = [];
        p(b, function(b2) {
          if (b2.localName === "link" && b2.getAttribute("rel") === "import") {
            var d2 = b2.import;
            d2 instanceof Node && (d2.__CE_isImportDocument = true, d2.__CE_hasRegistry = true);
            d2 && d2.readyState === "complete" ? d2.__CE_documentLoadHandled = true : b2.addEventListener("load", function() {
              var d3 = b2.import;
      ...
      function B(a) {
        ...
        this.b = void 0;
        A(this.c, this.a);
        this.a.readyState === "loading" && (this.b = new MutationObserver(this.f.bind(this)), this.b.observe(this.a, { childList: true, subtree: true }));
      }
      function C(a) {
        a.b && a.b.disconnect();
      }
      B.prototype.f = function(a) {
        ...
        b !== "interactive" && b !== "complete" || C(this);
      ...
      E.prototype.l = function(a, b) {
        ...
        try {
          var c = function(b2) {
            var a2 = e[b2];
            if (a2 !== void 0 && !(a2 instanceof Function))
      ...
      function Y(a, b, d) {
        ...
        d.h !== void 0 && (b.prepend = c(d.h));
        d.append !== void 0 && (b.append = c(d.append));
      }
      ;
      function ya() {
        var a = X;
      ...
      function za() {
        ...
        M && M.get ? a(Node.prototype, M) : ca(b, function(b2) {
          a(b2, { enumerable: true, configurable: true, get: function() {
            ...
            a2 != null && a2 !== "" && I.call(this, document.createTextNode(a2));
          } });
        });
      }
      ;
      function Aa(a) {
        ...
        V !== void 0 && (d.before = b(V));
        V !== void 0 && (d.after = b(qa));
        ra !== void 0 && r(d, "replaceWith", function(b2) {
      ...
      function Ba() {
          ...
          Object.defineProperty(a2, "innerHTML", { enumerable: b2.enumerable, configurable: true, get: b2.get, set: function(a3) {
            ...
            if (d2)
              for (var f = 0; f < d2.length; f++) {
                var t = d2[f];
                t.__CE_state === 1 && c.disconnectedCallback(t);
              }
        ...
        O && O.get ? a(Element.prototype, O) : W && W.get ? a(HTMLElement.prototype, W) : da(c, function(b2) {
          a(b2, {
            ...
            set: function(a2) {
              var b3 = this.localName === "template", c2 = b3 ? this.content : this, e = G.call(document, this.namespaceURI, this.localName);
        ...
        r(Element.prototype, "removeAttribute", function(a2) {
          ...
          R.call(this, a2);
          b2 !== null && c.attributeChangedCallback(this, a2, b2, null, null);
        });
      ...
      if (!Z || Z.forcePolyfill || typeof Z.define != "function" || typeof Z.get != "function") {
        var X = new u();
        xa();
        ya();
    ...
    typeof document.baseURI !== "string" && Object.defineProperty(Document.prototype, "baseURI", { enumerable: true, configurable: true, get: function() {
      var a = document.querySelector("base");
      return a && a.href ? a.href : document.URL;
    } });
    typeof window.CustomEvent !== "function" && (window.CustomEvent = function(c, a) {
    ...
    (function(b, c, d) {
      b.composedPath || (b.composedPath = function() {
        if (this.path)
          return this.path;
        var a = this.target;
        for (this.path = []; a.parentNode !== null; )
    ...
    (function(a) {
      typeof a.matches !== "function" && (a.matches = a.msMatchesSelector || a.mozMatchesSelector || a.webkitMatchesSelector || function(a2) {
        a2 = (this.document || this.ownerDocument).querySelectorAll(a2);
        for (var b = 0; a2[b] && a2[b] !== this; )
          ++b;
        return !!a2[b];
      });
      typeof a.closest !== "function" && (a.closest = function(a2) {
    ...
    !function(e) {
      "classList" in e || Object.defineProperty(e, "classList", { get: function() {
        ...
        return t[0] === "" && t.splice(0, 1), t.toggle = function(e3, i) {
          i !== void 0 ? i ? t.add(e3) : t.remove(e3) : t.indexOf(e3) !== -1 ? t.splice(t.indexOf(e3), 1) : t.push(e3), n();
        }, t.add = function() {
          for (var e3 = [].slice.call(arguments), i = 0, s = e3.length; i < s; i++)
            t.indexOf(e3[i]) === -1 && t.push(e3[i]);
          n();
        }, t.remove = function() {
          for (var e3 = [].slice.call(arguments), i = 0, s = e3.length; i < s; i++)
            t.indexOf(e3[i]) !== -1 && t.splice(t.indexOf(e3[i]), 1);
          n();
        }, t.item = function(e3) {
          return t[e3];
        }, t.contains = function(e3) {
          return t.indexOf(e3) !== -1;
        }, t.replace = function(e3, i) {
          t.indexOf(e3) !== -1 && t.splice(t.indexOf(e3), 1, i), n();
...
Element.remove()
*/
//# sourceMappingURL=dom-7LQRZL7N.js.map
